public class Main {
    ...
    public static String[][] ballotList = makeList(rawData);

    public static void main(String[] args) {
        int validVote=0;
        for (int i=0; i<ballotList.length; i++) {

            if(!isDuplicate(ballotList[i][0])){
                switch(ballotList[i][1]) {
                    case "1":
                        a1++;
                        break;
                    case "2":
    ...
    public static boolean isDuplicate(String voterid){
        int numfound = 0;
        for (int i = 0; i < ballotList.length; i++) {
            if (voterid.equals(ballotList[i][0])) {
                numfound++;
            }
        }
