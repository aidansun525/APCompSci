public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i=0; i<firstParse.length; i++) {
            String[] profile = firstParse[i].split(",");

            if(!isDuplicate(profile[0])){
                switch(profile[1]) {
                    case "1":
                        a1++;
                        break;
        ...
        System.out.println("There are "+validVote+ " valid votes.\n");
        System.out.println("Mordy Golding has "+a1+" votes.");
        System.out.println("Shira Gotshalk has "+a2+" votes.");
        System.out.println("Stephanie Evans has "+a3+" votes.");
        System.out.println("Ray Villalobos has "+a4+" votes.");
        ...
        System.out.println("Dona Sarkar has "+b1+" votes.");
        System.out.println("Tyler Ahn has "+b2+" votes.");
        System.out.println("Joe Camp has "+b3+" votes.");
        System.out.println("Brandon LeBlanc has "+b4+" votes.");
        ...
        System.out.println("Jason Howard has "+c1+" votes.");
        System.out.println("Nikki Rubino has "+c2+" votes.");
        System.out.println("Peggy Fisher has "+c3+" votes.");
        System.out.println("Neil Edde has "+c4+" votes.");
        ...
        System.out.println("David Gassner has "+d1+" votes.");
        System.out.println("Sharon Bennett has "+d2+" votes.");
        System.out.println("Walt Ritscher has "+d3+" votes.");
        System.out.println("Heather Hurley has "+d4+" votes.");
    ...
    public static boolean isDuplicate(String voterid){
        int numfound = 0;
        for (int i = 0; i < firstParse.length; i++) {
            if (voterid.equals(firstParse[i].substring(0, 5))) {
                numfound++;
            }
        }
